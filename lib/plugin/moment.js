// ! moment.js ! version : 2.10.6 ! authors : Tim Wood, Iskren Chernev, Moment.js
...
!function (a, b) {
    ...
    function d(a) {
        return a instanceof Date || "[object Date]" === Object
            .prototype
            .toString
            .call(a)
    }
    ...
    function u(a) {
        for (var b, c, d, e, f = 0; f < a.length;) {
            for (e = t(a[f]).split("-"), b = e.length, c = t(a[f + 1]), c = c
                ? c.split("-")
                : null; b > 0;) {
    ...
    function M(a) {
        return "function" == typeof a && "[object Function]" === Object
            .prototype
            .toString
            .call(a)
    }
    ...
    function X(a, b) {
        ...
        return "string" == typeof b && (b = a.localeData().monthsParse(b), "number" != typeof b)
            ? a
            : (c = Math.min(a.date(), T(a.year(), b)), a._d["set" + (a._isUTC
                    ? "UTC"
                    : "") + "Month"](b, c), a)
    }
    function Y(b) {
    ...
    function $(a) {
        var b,
            c = a._a;
        return c && -2 === j(a).overflow && (b = c[gd] < 0 || c[gd] > 11
            ? gd
            : c[hd] < 1 || c[hd] > T(c[fd], c[gd])
                ? hd
                : c[id] < 0 || c[id] > 24 || 24 === c[id] && (0 !== c[jd] || 0 !== c[kd] || 0 !== c[ld])
                    ? id
                    : c[jd] < 0 || c[jd] > 59
                        ? jd
                        : c[kd] < 0 || c[kd] > 59
                            ...
                            : c[ld] < 0 || c[ld] > 999
                                ? ld
                                : -1, j(a)._overflowDayOfYear && (fd > b || b > hd) && (b = hd), j(a).overflow = b),
        a
    }
    function _(b) {
    ...
    function da(b) {
        ...
        return null !== c
            ...
            : (ca(b), void(b._isValid === !1 && (delete b._isValid, a.createFromInputFallback(b))))
    }
    ...
    function ta(a) {
        ...
        if (!a._d) {
            ...
            null != a._tzm && a
                ._d
                .setUTCMinutes(a._d.getUTCMinutes() - a._tzm),
    ...
    function ua(a) {
        ...
        null != b.GG || null != b.W || null != b.E
            ? (f = 1, g = 4, c = ra(b.GG, a._a[fd], ja(Da(), 1, 4).year), d = ra(b.W, 1), e = ra(b.E, 1))
            : (f = a._locale._week.dow, g = a._locale._week.doy, c = ra(b.gg, a._a[fd], ja(Da(), f, g).year), d = ra(b.w, 1), null != b.d
                ? (e = b.d, f > e && ++d)
                : e = null != b.e
                    ? b.e + f
                    : f),
    ...
    function va(b) {
        ...
        for (e = L(b._f, b._locale).match(Nc) || [], c = 0; c < e.length; c++) 
            ...
            Qc[f]
                ? (d
                    ? j(b).empty = !1
                    : j(b).unusedTokens.push(f), S(f, d, b))
    ...
    function Aa(a) {
        ...
        null === b || void 0 === e && "" === b
            ...
            : ("string" == typeof b && (a._i = b = a._locale.preparse(b)), o(b)
                ? new n($(b))
                : (c(e)
                    ? xa(a)
                    : e
    ...
    function La(b, c) {
        var e,
            f;
        return c._isUTC
            ? (e = c.clone(), f = (o(b) || d(b) ?+ b :+ Da(b)) - + e, e._d.setTime(+ e._d + f), a.updateOffset(e, !1), e)
            : Da(b).local()
    }
    function Ma(a) {
    ...
    function Na(b, c) {
        var d,
            e = this._offset || 0;
        return null != b
            ? ("string" == typeof b && (b = Ka(b)), Math.abs(b) < 16 && (b = 60 * b), !this._isUTC && c && (d = Ma(this)), this._offset = b, this._isUTC = !0, null != d && this.add(d, "m"), e !== b && (!c || this._changeInProgress
            ...
            : "number" == typeof a
                ...
                : (h = yd.exec(a))
                    ...
                    : (h = zd.exec(a))
                        ...
                        : null == g
                            ? g = {}
                            : "object" == typeof g && ("from" in g || "to" in g) && (e = _a(Da(g.from), Da(g.to)), g = {}, g.ms = e.milliseconds, g.M = e.months),
        d = new Ha(g),
    ...
    function _a(a, b) {
        ...
        a.isBefore(b)
            ? c = $a(a, b)
            : (c = $a(b, a), c.milliseconds = -c.milliseconds, c.months = -c.months),
        c
    }
    function ab(a, b) {
        return function (c, d) {
    ...
    function hb(a, b) {
        ...
        "millisecond" === b
            ? (a = o(a)
                ? a
                : Da(a), + this ===+ a)
            : (c =+ Da(a), + this.clone().startOf(b) <= c && c <=+ this.clone().endOf(b))
    }
    function ib(a, b, c) {
        var d,
            e,
    ...
    Q([
        ...
        var e = c
            ._locale
            .monthsParse(a, d, c._strict);
        null != e
            ? b[gd] = e
            : j(c).invalidMonth = a
    });
    var md = ("January_February_March_April_May_June_July_August_September_October_November_De" +
                "ember").split("_"),
    ...
    var pd = /^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,
        ...
        sd = /^\/?Date\((\-?\d+)/i;
    a.createFromInputFallback = aa("moment construction falls back to js Date. This is discouraged and will be remov" +
            "ed in upcoming major release. Please refer to https://github.com/moment/moment/i" +
            "ssues/1407 for more info.",
    function (a) {
    ...
    a.ISO_8601 = function () {};
    var vd = aa("moment().min is deprecated, use moment.min instead. https://github.com/moment/mo" +
                "ment/issues/1548",
        function () {
        ...
        wd = aa("moment().max is deprecated, use moment.max instead. https://github.com/moment/mo" +
                "ment/issues/1548",
        function () {
            var a = Da.apply(null, arguments);
            return a > this
    ...
    var Cd = aa("moment().lang() is deprecated. Instead, use moment().localeData() to get the lan" +
    ...
    Nd.zone = aa("moment().zone is deprecated, use moment().utcOffset instead. https://github.com/" +
            "moment/moment/issues/1779",
    Oa);
    var Od = Nd,
        Pd = {
            sameDay: "[Today at] LT",
    ...
    ne.locale = rb,
    ne.localeData = sb,
    ne.toIsoString = aa("toIsoString() is deprecated. Please use toISOString() instead (notice the capita" +
            "ls)",
    Gc),
    ne.lang = Cd,
    H("X", 0, 0, "unix"),
